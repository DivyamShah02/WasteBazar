...
function shareListing() {
  if (navigator.share) {
    ...
    navigator
      .share({
        title: "High-Grade PET Bottle Bales - WasteBazaar",
        text: "Check out this premium plastic waste listing on WasteBazaar",
...
function fallbackShare() {
  ...
  const shareText = "Check out this premium plastic waste listing on WasteBazaar"
  ...
  const shareOptions = [
    ...
    },
    {
      ...
      action: () => {
        window.open(
          `mailto:?subject=${encodeURIComponent("WasteBazaar Listing")}&body=${encodeURIComponent(shareText + " " + shareUrl)}`,
        )
      },
    },
  ]
